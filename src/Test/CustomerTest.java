...
import DAOs.ReservationDaoImpl;
...
public class CustomerTest {
    ...
    public void TestARegistration() {
        ...
        setUp();
        Customer customer = customerDao.getCustomer("test1@email", "password");
    ...
    public void TestMMakeReservationOnHoliday() {
        ...
        assertFalse(reservationDao.checkTestReservation(testCustomer, Date.valueOf(date)));
    }

    @Test
    public void TestNDeleteReservation() {
        ReservationDaoImpl reservationDao = new ReservationDaoImpl();
        ArrayList<Integer> reservationsId = reservationDao.getReservationsId(testCustomer.getId());
    ...
    static void tearDown() {
        CustomerDaoImpl customerDao = new CustomerDaoImpl();
        customerDao.deleteTestCustomer("test1@email");
    }
