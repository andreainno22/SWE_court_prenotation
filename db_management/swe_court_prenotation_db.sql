...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 30, 2023 at 11:00 AM
...
(44, 'pippo', 'pippi', 'pippino', 'pippo', 0, 0, 0, 44);
...
INSERT INTO `reservation` (`id`, `date`, `court`, `client`, `time_slot`) VALUES
(1, '2023-09-30', 1, 1, 2);
...
--
ALTER TABLE `reservation`
  ADD CONSTRAINT `reservation_client` FOREIGN KEY (`time_slot`) REFERENCES `time_slots` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
